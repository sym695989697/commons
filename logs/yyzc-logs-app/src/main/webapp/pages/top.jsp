...
<script type="text/javascript">
 ...
 function logout(){
	...
	<div class="header">
		...
		<img src="../images/top/header/logo.png" title="虚拟币管理系统" class="logo" />
		<ul class="header_info">
			<li>
				<span>当前用户：</span>
				<span class="mr10">
					<a href="#"  onclick="indexPage.showOrgInfo();"><span id="topOrgName">中交兴路车联网信息科技有限公司</span></a>
				</span>-
				<span class="mr10">
					<a href="#"><span id="topRoleName">角色信息</span></a>
				</span>-
				<span class="mr10">
