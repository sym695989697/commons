...
(function ($)
{
    ...
    $.ligerDefaults.Filter.editors['combobox'] =
    {
        create: function (container, field)
        {
            ...
            container.append(input);
            var options = {
                //data: field.data, //by malq 2014-06-17
    ...
    $.ligerui.controls.Filter.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _bulidGroupTableHtml: function (altering, allowDelete)
        {
            ...
            //tableHtmlArr.push('<option value="or">' + p.strings['or'] + '</option>');//by malq 2014-06-17
            tableHtmlArr.push('</select>');

            //add group
            //tableHtmlArr.push('<input type="button" value="' + p.strings['addgroup'] + '" class="addgroup">');//by malq 2014-0617
            //add rule
