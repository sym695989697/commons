package com.sinoiov.yyzc.commons.mongodb.csm.local;
...
public class DynamicSqlParameter implements Serializable {
	 ...
	 */
	private Map<String, Object> startwith;
	
	/**
	 * 参数使用以xxx结束方式查询设置key与value{字段名：值}
	 */
	private Map<String, Object> endwith;
	...
	public Map<String, Object> getStartwith() {
		return startwith;
	}

	public void setStartwith(Map<String, Object> startwith) {
		this.startwith = startwith;
	}

	public Map<String, Object> getEndwith() {
		return endwith;
	}

	public void setEndwith(Map<String, Object> endwith) {
	...
	public String toString(){
		...
		if(!(notInMap == null||notInMap.size()==0)) {buff.append("[不在...中条件:").append(notInMap).append("]");}
